...
<html>
<head>
    <title>Add Furniture - Rental Listings</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h1 class="mb-0"><i class="fas fa-plus"></i> Add New Furniture</h1>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('listings.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="rent_per_month" 
                                       name="rent_per_month" min="0" placeholder="0.00" 
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Add Furniture
                                </button>
                            </div>
                        </form>
                    </div>
